# Credit: https://github.com/vitalyavolyn/instagram-downloader/blob/master/instagram-downloader.py
# JHO's note:
#   seems like IG changed something and this doesn't work anymore
#!/usr/bin/python3
import requests
import os
